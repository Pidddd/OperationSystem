...
* Karena saya menggunakan WSL (Ubuntu), saya tidak perlu melakukan partisi manual seperti pada gambar karena WSL menggunakan sistem Virtual Disk (.vhdx) yang bersifat otomatis dan dinamis. Seluruh kebutuhan sistem seperti Root, Home, hingga Swap sudah dikelola langsung oleh Windows, sehingga kapasitas penyimpanannya akan membesar atau mengecil secara fleksibel mengikuti jumlah file tugas saya tanpa perlu menyekat-nyekat kapasitas harddisk di awal.
...
```
![](Images/1.7.6%20mkdir.png "")

5. Permanent mount - edit /etc/fstab
```
 cat /etc/fstab
```
![](Images/1.7.6%20cat.png "")
